...
var sered=Math.floor(count/2);
 ...
 //alert(sered);
	...
	if(jQuery(".checklist").length) {
		jQuery('<center><div id="yandex_rtb_R-A-646917-3"></div></center>').insertBefore(jQuery(".checklist"));
 
		 (function(w, d, n, s, t) {
        w[n] = w[n] || [];
        w[n].push(function() {
            Ya.Context.AdvManager.render({
                blockId: "R-A-646917-3",
                renderTo: "yandex_rtb_R-A-646917-3",
                async: true
            });
        });
	...
	// конец контента
	if(jQuery(".checklist").length) {
		jQuery('<center><div id="yandex_rtb_R-A-646917-4"></div></center>').insertAfter(jQuery(".checklist"));
 
		 (function(w, d, n, s, t) {
        w[n] = w[n] || [];
        w[n].push(function() {
            Ya.Context.AdvManager.render({
                blockId: "R-A-646917-4",
                renderTo: "yandex_rtb_R-A-646917-4",
                async: true
            });
        });
        t = d.getElementsByTagName("script")[0];
